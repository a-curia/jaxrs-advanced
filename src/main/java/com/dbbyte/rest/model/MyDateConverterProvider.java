 ...
 * 
 * @author adrian
 * register this class as a Provider for JAX-RS using @Provider
 *
 */
@Provider
	...
	public <T> ParamConverter<T> getConverter(Class<T> rawType, Type genericType, Annotation[] annotations) {
		...
		if (rawType.getName().equals(MyDate.class.getName())) {
			...
			return new ParamConverter<T>() {
				...
				/**
				 * the Param annotations maps incoming request parameters, so we are just interested in string-to-DataType conversion here
				 */
			};
		}
		// else return null
